"""
Django settings for SocialTennis_proj project.
...
INSTALLED_APPS = [
    'SocialTennis.apps.SocialtennisConfig',
...
ROOT_URLCONF = 'SocialTennis_proj.urls'
...
WSGI_APPLICATION = 'SocialTennis_proj.wsgi.application'
